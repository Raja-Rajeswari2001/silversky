    ...
    <div class="container-fluid position-relative p-0">
        <nav class="navbar navbar-expand-lg navbar-light px-4 px-lg-5 py-3 py-lg-0">
            <a href="" class="navbar-brand p-0">
                <h1 class="m-0"><i class="fa fa-map-marker-alt me-3"></i>SILVER SKY HOLIDAYS</h1>
...
// Fetch package type details
$sql_package_type = "SELECT * FROM tbl_packagetype WHERE id='$type'";
$result_package_type = mysqli_query($conn, $sql_package_type);
$row_package_type = mysqli_fetch_assoc($result_package_type);
?>

    <section class="inner-2" style="margin-top:-130px">
        <div class="container-fluid">
            <h2 class="text-center py-4">Packages - <?php echo htmlspecialchars($row_package_type['type_name']); ?></h2>
        </div>
    </section>

    <section class="inner-3">
        <div class="container-fluid">
            <div class="bg-white p-3" style="display:flow-root">
                <div class="row">
                    <?php
                // Fetch tour packages
                ...
                ?>
                    <div class="col-md-3 mb-4">
                        <div class="packages-item">
                            <div class="packages-img position-relative">
                                <img src="images/<?php echo htmlspecialchars($row_package['package_image']); ?>"
                                    class="img-fluid w-100 rounded-top" alt="Image">
                                <div class="packages-info d-flex border position-absolute w-100 bottom-0 z-5 text-white"
                                    style="background: rgba(0, 0, 0, 0.6);">
                                    <small class="flex-fill text-center border-end py-2">
                                        <i class="fa fa-map-marker-alt me-2"></i>
                                        <?php echo htmlspecialchars($row_package['package_location']); ?>
                                    </small>
                                    <small class="flex-fill text-center border-end py-2">
                            ...
                            <div class="packages-content bg-light">
                                <div class="p-4 pb-0">
                                    <h5 class="mb-0"><?php echo htmlspecialchars($row_package['package_name']); ?></h5>
                                    <small class="text-uppercase">Hotel Deals</small>
                                    <div class="mb-3">
                                        <?php for ($i = 0; $i < 5; $i++) { ?>
                                        <small class="fa fa-star text-primary"></small>
                                    ...
                                    <div class="packages-price py-2 px-4">Rs.
                                        <?php echo htmlspecialchars($row_package['package_price']); ?>
                                    </div>
                                    <p class="mb-4">Lorem ipsum dolor sit amet consectetur adipisicing elit.</p>
                                </div>
                                <div class="row bg-primary rounded-bottom mx-0 p-2">
                                    <div class="col-6 text-start px-0">
                                        <?php if ($loggedin) { ?>
                                        <a href="package-details.php?id=<?php echo $row_package['id']; ?>&type=<?php echo $type; ?>"
                                            class="btn btn-light text-primary px-2 py-2">View Details</a>
                                        <?php } else { ?>
                                    ...
                                    <div class="col-6 text-end px-0">
                                        ...
                                        <a href="booking.php" class="btn btn-light text-primary px-4 py-2">Book Now</a>
                                        <?php } else { ?>
                                        <!-- Show Login button if user is NOT logged in -->
                                        <a href="#" class="btn btn-light text-primary px-4 py-2" data-toggle="modal"
                                            data-target="#loginModal">Login to Book</a>
                                        <?php } ?>
                    ...
                    <div class="col-12 text-center">
                        <p class="text-dark">No packages available.</p>
                    </div>
                    <?php } ?>
                </div>
            </div>
