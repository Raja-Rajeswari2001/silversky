...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($stmt->execute()) {
        $message = "<div class='alert alert-success'>Contact Submitted Successfully!</div>";
    } else {
                    ...
                    <div class="container mt-5">
                        ...
                        <form method="post" action="_contact.php">
                            <div class="row g-3">
                                ...
                                <div class="col-md-6">
                                    <div class="form-floating">
                                        <input type="email" class="form-control border-0" id="emailid" name="emailid"
                                ...
                                <div class="col-12">
                                    <div class="form-floating">
                                        <textarea class="form-control border-0" id="message" name="message" required
                                            placeholder="Leave a message here" style="height: 160px"></textarea>
