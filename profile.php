                                ...
                                <form method="post" action="_profileUpdate.php">
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input id="name" name="name" type="text" placeholder="Enter Your Name*"
                                                    class="form-control" value="<?php echo $name; ?>" required><br><br>
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            ...
                                            <div class="form-group">
                                                <label class="control-label">
                                                    <h3 style="color:white">Emailid:</h3>
                                                </label>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <div class="form-group">
                                                <label class="control-label">
                                                    <h3 style="color:white">Phone No.:</h3>
                                                </label>
                                                <input id="phone" name="phone" type="text"
                                                    placeholder="Enter Your Phone No*" class="form-control"
                                                    value="<?php echo $mobile; ?>" required><br><br>
                                            </div>
                                        </div>
